...
export const encouterStart = (e: Encounter): string => formatHumanDateTime(e.period?.start);
export const encouterEnd = (e: Encounter): string => formatHumanDateTime(e.period?.end);
...
export const immunizationVaccine = compileAsFirst<Immunization, string>(
...
export const patientMedicare = compileAsFirst<Patient, string>(
    "Patient.identifier.where(type.coding.code = 'MC').value",
);
